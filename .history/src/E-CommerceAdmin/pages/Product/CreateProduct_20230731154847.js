...
const CreateProduct = () => {
  ...
  const [taxInclude, setTaxInclude] = useState("True" ? true : false);
  const [tax, setTax] = useState(0);
  const [discount, setDiscount] = useState("True" ? true : false);
  const [discountPrice, setDiscountPrice] = useState(0);
  const [colorActive, setColorActive] = useState("true" ? true : false);
  const [size, setSize] = useState("true" ? true : false);
