...
const EditProduct = () => {
  ...
  useEffect(() => {
    if (data) {
      ...
      setNutritionId(data?.nutritionId === null || undefined ? "" : data?.nutritionId);
      seteSkinTypeId(data?.skinTypeId === null || undefined ? "" : data?.skinTypeId);
      setProductTypeId(data?.productTypeId === null || undefined ? "" : data?.productTypeId);
      setSkinConditionId(data?.skinConditionId === null || undefined ? "" : data?.skinConditionId);
      setBrandId(data?.brandId === null || undefined ? "" : data?.nutritionId);
