  ...
  function MyVerticallyCenteredModal(props) {
    ...
    return (
      ...
      >
        ...
        {ValueChecker(edit?.scheduling?.picked_up_on , "Pickup u")}
        {ValueChecker(edit?.scheduling?.delivered_on , "Pickup Date")}
        {ValueChecker(edit?.scheduling?.estimated_delivery_date_minimum , "Pickup Date")}
        {ValueChecker(edit?.scheduling?.estimated_delivery_date_maximum , "Pickup Date")}
        {ValueChecker(edit?.scheduling?.status , "Pickup Date")}
        {ValueChecker(edit?.scheduling?.is_cancellable , "Pickup Date")}
