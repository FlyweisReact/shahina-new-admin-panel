  ...
  function MyVerticallyCenteredModal(props) {
    ...
    return (
      ...
      >
        ...
        {ValueChecker(edit?.sender?.address?.suburb, "SSuburb")}
        {ValueChecker(edit?.sender?.address?.state_name, "Address Line 1")}
        {ValueChecker(edit?.sender?.address?.postcode, "Address Line 1")}
        {ValueChecker(edit?.sender?.address?.country, "Address Line 1")}
        </Modal.Body>
      </Modal>
    );
  }
