...
const Cart = () => {
  ...
  const checkoutHandler = async () => {
    try{
      const response = await  axios.post(`${Baseurl}api/v1/admin/checkout/${id}` , {} , Auth)
    ...
    <>
      ...
      <section className="sectionCont">
        ...
        <div className="pb-4  w-full flex justify-between items-center">
          ...
          ></span>
          <div className="d-flex gap-2">
            <button className="md:py-2 px-3 md:px-4 py-1 rounded-sm bg-[#042b26] text-white tracking-wider" onClick={() => checkoutHandler()} >
              Checkout
            </button>
          </div>
        </div>
