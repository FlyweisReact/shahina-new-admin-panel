...
const Cart = () => {
  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(`${Baseurl}api/v1/admin/getCart/${id}` , Auth);
      setData(data.cart);
    } catch (e) {
      console.log(e);
    }
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            <Form.Group className="mb-3">
              ...
              <Form.Select  required  onChange={(e) => setProductId(e.target.value)}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control required type="number" min={0} onChange={(e) => setQuantity(e.target.value)} />
            </Form.Group>
