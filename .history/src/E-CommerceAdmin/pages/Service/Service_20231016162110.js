    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
          `${Baseurl}api/v1/Service/all/paginateServiceSearch?page=${page}&limit=${limit}&search=JetPeel api/v1/Product/all/paginateProductSearch?page=${page}&limit=${limit}&search=${query}`
        );
        setData(data.data);
