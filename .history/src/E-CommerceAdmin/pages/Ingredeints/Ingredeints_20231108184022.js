  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        `${Baseurl}api/v1/admin/Ingredient/allIngredient`
      );
      setData(data.data);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          `${Baseurl}api/v1/admin/Ingredient/addIngredient`,
          payload,
          Auth
        );
    ...
    const putHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `${Baseurl}api/v1/admin/Ingredient/updateIngredient/${id}`,
          payload,
          Auth
        );
        toast.success(data.message);
  ...
  const deleteHandler = async (ide) => {
    try {
      const { data } = await axios.delete(
        `${Baseurl}api/v1/admin/Ingredient/deleteIngredient/${ide}`,
        Auth
      );
      toast.success(data.message);
      fetchData();
