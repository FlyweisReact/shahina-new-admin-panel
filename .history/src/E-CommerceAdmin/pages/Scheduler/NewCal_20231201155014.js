...
//   Add Service
const MyOtherModal = (props) => {
    // Add logic and UI for the other modal
    return (
      <Modal
        {...props}
        size="lg"
        ...
        centered
      >
        {/* Add content for the other modal */}
        {/* For example: */}
        <Modal.Body>
          <h4>Other Modal Content</h4>
          {/* Add other content or form elements */}
        </Modal.Body>
        <Modal.Footer>
