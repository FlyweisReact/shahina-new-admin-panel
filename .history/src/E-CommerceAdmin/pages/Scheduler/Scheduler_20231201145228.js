...
const Scheduler = () => {
  ...
  const AddServiceModal = ({ show, onHide, slot }) => {
    const handleAddService = () => {
      // Implement the logic to add a service at the selected slot
      // You may need to make an API call or update the state accordingly
      // Don't forget to close the modal after adding the service
      onHide();
    };
    ...
    return (
      <Modal show={show} onHide={onHide} size="lg" centered>
        ...
        <Modal.Body>
          {/* Your form to add service goes here */}
          {/* You can use the slot variable to display the selected date and time */}
          <Form>
    ...
    <>
      ...
      <section className="sectionCont">
        <Calendar
          ...
          onSelectSlot={(slot) => handleSlotHover(slot)}
          style={{ height: 800 }}
