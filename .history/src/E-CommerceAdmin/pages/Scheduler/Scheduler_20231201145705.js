...
const Scheduler = () => {
  ...
  const AddServiceModal = ({ show, onHide, slot }) => {
    console.log("AddServiceModal show:", show);
    ...
    <>
      ...
      <section className="sectionCont">
        <Calendar
          ...
          onSelectSlot={(slot) => handleSlotHover(slot)}
          onMouseOverSlot={(slot) => handleSlotHover(slot)}
          onMouseOutSlot={() => setHoveredSlot(null)} // Clear hover state on mouse out
          style={{ height: 800 }}
        />
      </section>
    </>
