...
import { addService, getCart } from "../../../../Respo/Api";
          ...
          <div className="user_select_container">
            <div className="user_select">
              ...
              <div className="content">
                <p className="heading">
                  {" "}
                  {cart?.user?.firstName + " " + selectedUser?.lastName}{" "}
                </p>
          ...
          <div className="service_selector_container">
            ...
            >
              <div>
                ...
                <p className="faded"> {selectedService?.totalTime} </p>
              </div>
          ...
          <div className="select_container">
            ...
            <div className="last_button">
              <div className="text">
                <p>Total</p>
                <p>
                  From ${selectedService?.price} ({selectedService?.totalTime})
                </p>
              </div>
