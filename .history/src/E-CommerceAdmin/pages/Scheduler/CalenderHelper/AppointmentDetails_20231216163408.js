...
const AppointmentDetails = ({
  ...
  const startingTime = new Date(detail?.fromtime)
  // const startingTime = detail?.fromTime?.toLocaleTimeString([], {
  //   hour: "2-digit",
  //   minute: "2-digit",
  // });
            ...
            {detail?.services?.map((i, index) => (
              ...
              >
                <div>
                  ...
                  <p className="faded"> 11:30am - 11:45am ({i.serviceId?.totalMin}min) </p>
