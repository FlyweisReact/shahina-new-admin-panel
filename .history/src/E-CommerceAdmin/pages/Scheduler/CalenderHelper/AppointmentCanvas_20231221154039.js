...
export const AppointmentCanvas = ({ show, handleClose, startTime }) => {
  ...
  // Code to send email
  const attachments = [];
  const serviceToPdfPathMap = { "JetPeel Facial": "JetPeelPreandPost.pdf",  "PRP Hair Loss Treatment": "LaserhairremovalPrepCare.pdf",    "PRP Microneedling": "MicroneedlingPre.pdf",
