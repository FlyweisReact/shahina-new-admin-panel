...
const AppointmentDetails = ({
  ...
  const modifiedYear = originalDate.getFullYear();
      const modifiedMonth = (originalDate.getMonth() + 1).toString().padStart(2, "0");
      const modifiedDay = originalDate.getDate().toString().padStart(2, "0");
      
  console.log(`${modifiedYear}-${modifiedMonth}-${day}`);
