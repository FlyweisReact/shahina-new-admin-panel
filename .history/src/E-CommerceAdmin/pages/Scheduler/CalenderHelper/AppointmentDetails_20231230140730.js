          ...
          {detail?.services?.length > 0 && (
            <>
              ...
              <div className="booked_service d-flex flex-wrap gap-4">
                ...
                // Define adjustedStartTime outside of the loop
...
{detail?.services?.map((i, index) => {
  // Use the previously calculated adjustedStartTime as the current start time
  ...
  // Update adjustedStartTime for the next iteration
  ...
  return (
    ...
    >
      <div>
        <p className="title">{`${formattedStartTime} - ${formattedEndTime}`}</p>
        <p className="title">{i.serviceId?.name}</p>
        <p className="faded">{`${i.serviceId?.totalTime} min`}</p>
        <p className="faded">Shahina Hoja</p>
        <p className="faded">{`$${i.serviceId?.price}`}</p>
      </div>
    </div>
