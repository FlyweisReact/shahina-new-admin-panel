...
const AppointmentDetails = ({
  ...
  // const formattedStartTime = adjustedEndTime.toLocaleTimeString("en-US", {
  //   hour: "numeric",
  //   minute: "numeric",
  //   hour12: true,
  // });
    ...
    const SlidingComponent = () => {
      return (
        <>
              ...
              <div className="booked_service d-flex flex-wrap gap-4">
                ...
                {/* {detail?.services?.map((i, index) => {
                  ...
                  const newEndTime = new Date(
                    adjustedEndTime.getTime() + i.serviceId.totalMin * 60000
                  );
                  const formattedNewEndTime = newEndTime.toLocaleTimeString(
                    "en-US",
                    {
                      hour: "numeric",
                      minute: "numeric",
                  ...
                  console.log(formattedNewEndTime);
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className="title">{formattedNewEndTime}</p>
                        <p className="title">{i.serviceId?.name}</p>
                        <p className="faded">{`${i.serviceId?.totalTime}`}</p>
                        <p className="faded">Shahina Hoja</p>
                        <p className="faded">{`$${i.serviceId?.price}`}</p>
          ...
          // Assuming adjustedEndTime is defined before the main block of your
          component
          {detail?.AddOnservicesSchema?.length > 0 && (
            <>
              <p
              ...
              <div className="booked_service d-flex flex-wrap gap-4">
                {detail?.AddOnservicesSchema?.map((i, index) => {
                  // Use the adjustedEndTime from the regular service as the starting time
                  const formattedStartTime = adjustedEndTime.toLocaleTimeString(
                    "en-US",
                    {
                      hour: "numeric",
                      minute: "numeric",
                  ...
                  // Calculate end time after totalMin minutes
                  ...
                  // Update adjustedEndTime for the next iteration
                  adjustedEndTime.setHours(adjustedEndTimeAddon.getHours());
                  adjustedEndTime.setMinutes(adjustedEndTimeAddon.getMinutes());
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className="title">{`${formattedStartTime} - ${formattedEndTimeAddon}`}</p>
                        <p className="title">{i.addOnservicesId?.name}</p>
                        <p className="faded">{`${i.addOnservicesId?.totalTime} min`}</p>
                        <p className="faded">Shahina Hoja</p>
                        <p className="faded">{`$${i.addOnservicesId?.price}`}</p>
                      </div>
                    </div>
