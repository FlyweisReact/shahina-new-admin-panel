...
const AppointmentDetails = ({
  ...
  // Calculate time after 108 minutes
  const newEndTime = new Date(adjustedEndTime.getTime() + 108 * 60000);

  // Format the new end time
  const formattedNewEndTime = newEndTime.toLocaleTimeString("en-US", {
    hour: "numeric",
    minute: "numeric",
    hour12: true,
  });

  console.log("New End Time after 108 minutes:", formattedNewEndTime);
            ...
            <>
              ...
              <div className="booked_service d-flex flex-wrap gap-4">
                ...
                {detail?.services?.map((i, index) => {
                  ...
                  // Calculate time after totalTime minutes
                  const newEndTime = new Date(
                    adjustedEndTime.getTime() + i.serviceId.totalTime * 60000
                  );
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <p className="faded">Shahina Hoja</p>
                        <p className="faded">{`$${i.serviceId?.price}`}</p>
                        <p className="faded">{`End Time: ${formattedNewEndTime}`}</p>
                      </div>
                    </div>
                  );
                })}
