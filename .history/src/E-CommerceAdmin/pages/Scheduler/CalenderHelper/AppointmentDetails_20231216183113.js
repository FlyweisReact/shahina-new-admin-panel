...
const AppointmentDetails = ({
  ...
  console.log(new Date(start)?.get())
  console.log(new Date(start)?.getFullYear())

  // Open Service Edit Handler
  function edit_service_open(id) {
    setServiceId(id);
    setService_Edit_Visible(true);
  }
