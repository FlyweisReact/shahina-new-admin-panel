...
export const DetailDialog = ({ show, setShow, selector, type, Date, id ,orderId }) => {
  ...
  return (
    <>
      <CancelCanvas show={cancelVisible} handleClose={hideCancel} id={id} />
...
export const CancelCanvas = ({ show, handleClose, id }) => {
