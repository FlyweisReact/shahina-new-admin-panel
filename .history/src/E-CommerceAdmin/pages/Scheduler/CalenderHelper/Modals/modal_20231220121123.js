...
import { deleteService, getRecentService, noShow, uploadUser } from "../../../../../Respo/Api";
    ...
    >
      ...
      <Offcanvas.Body className="Appointment_Canvas">
        ...
        <div className="recently_booked">
          <p className="heading">Recently booked by  {userDetail?.firstName + " " + userDetail?.firstName } </p>
          <Slider {...settings}>
            {service?.map((i, index) => (
