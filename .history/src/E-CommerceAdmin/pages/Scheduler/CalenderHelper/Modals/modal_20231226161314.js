...
export const EditProfile = ({ show, handleClose, data }) => {
  ...
  const [lastName, setLastName] = useState(data?.user?.firstName);
  const [email, setEmail] = useState(data?.user?.email);
  const [countryCode, setCountryCode] = useState(data?.user?.firstName);
  const [phone, setPhone] = useState(data?.user?.firstName);
  const [gender, setGender] = useState(data?.user?.firstName);
  const [dob, setDob] = useState(data?.user?.firstName);
  const [bio, setBio] = useState(data?.user?.firstName);
