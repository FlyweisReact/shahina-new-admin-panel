        ...
        {type === "Regular" ? (
          <form>
            ...
            <div style={flexContainer}>
              ...
              <div style={halfWidth}>
                <p>Duration</p>
                <select value={totalTime}  onChange={(e) => setTotalTime(e.target.value)} >
                  <option ></option>
                  <option value={'15min'} >15min</option>
                  <option value={'15min'}>30min</option>
                  <option value={'15min'}>45min</option>
                  <option value={'15min'}>1hour</option>
                  <option value={'15min'}>1hour 15min</option>
                  <option value={'15min'}>1hour 30min</option>
                  <option value={'15min'}>1hour 45min</option>
                  <option value={'15min'}>2hour</option>
                </select>
              </div>
            </div>
