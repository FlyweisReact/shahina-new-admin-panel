...
export const UserDialog = ({ show, setShow }) => {
  ...
  return (
    <>
      <EditProfile show={profile} handleClose={closeProfile} />
      <Modal
        show={show}
        onHide={() => setShow(false)}
        className="text_Modal"
      ...
      <Offcanvas.Body>
        <div className="Appointment_Canvas" style={{ paddingTop: 0 }}>
          ...
          >
            <div className="user_select" style={{ border: "none" }}>
              ...
              <div className="content">
                <p className="heading"> Ahlam Saad</p>
                <p className="faded"> ahlamrabah@yahoo.com </p>
                <p className="faded">+1 214-514-0305 </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="booked_appointment_modal edit-profile-canvas">
          <form>
            ...
            <div>
              <h4 style={} >Important client info</h4>
              <p>Important client info will only be visible to you and team members</p>
              <p>Client info</p>
              <textarea rows={5} />
            </div>
