...
export const EditProfile = ({ show, handleClose, data }) => {
  ...
  const [showOnAllBooking, setShowOnAllBooking] = useState("");
  const [sendEmailNotification, setSendEmailNotification] = useState("");
  const [sendTextNotification, sentTextNotification] = useState("");
  const [ sendEmailMarketingNotification , setSendEmailMarketingNotification ] = useState("")
  const [ sendTextMarketingNotification , setSendTextMarketing]
  const [id, setId] = useState("");
