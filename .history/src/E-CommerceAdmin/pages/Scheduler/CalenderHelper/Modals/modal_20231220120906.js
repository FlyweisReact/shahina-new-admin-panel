...
import { deleteService, noShow, uploadUser } from "../../../../../Respo/Api";
...
export const ServiceCanvas = ({ show, handleClose, serviceHandler , userDetail }) => {
  ...
  const fetchRecent = () => {
    getRecentService(userDetail?._id) 
  }
