...
export const EditService = ({
  ...
  const addInCart = (e) => {
    e.preventDefault();
    edit_service(id, payload, fetchCart);
    setShow(false);
  };
  ...
  const addAdOn = async (e) => {
    ...
    deleteAnother();
    await AdOnInCart(id, payload, fetchCart);
    setShow(false);
  };
  ...
  useEffect(() => {
    if (totalTime === "15min") {
      setTotalMin(15);
    } else if (totalTime === "30min") {
      setTotalMin(30);
    } else if (totalTime === "45min") {
      setTotalMin(45);
    } else if (totalTime === "1hr") {
      setTotalMin(60);
    } else if (totalTime === "1hr 15min") {
      setTotalMin(75);
    } else if (totalTime === "1hr 30min") {
      setTotalMin(90);
    } else if (totalTime === "1hr 45min") {
      setTotalMin(105);
    } else if (totalTime === "2hr") {
      setTotalMin(120);
    }
  }, [totalTime]);
  ...
  function convertToMinutes(timeString) {
    // Extract hours and minutes from the input string using regular expressions
    ...
    if (match) {
      ...
      console.error(
        'Invalid input format. Please use the format like "1hr 30min" or "3hr 45min".'
      );
      return null;
    }
  }
  ...
  // Example usage:
  const totalMinutes1 = convertToMinutes("1hr 30min");
  console.log(totalMinutes1); // Output: 90

  const totalMinutes2 = convertToMinutes("3hr 45min");
  console.log(totalMinutes2); // Output: 225
            ...
            <div style={flexContainer}>
              ...
              <div style={halfWidth}>
                ...
                >
                  ...
                  <option value={"1hr 15min"}>1hour 15min</option>
                  <option value={"1hr 30min"}>1hour 30min</option>
                  <option value={"1hr 45min"}>1hour 45min</option>
                  <option value={"2hr"}>2hour</option>
                </select>
              </div>
            </div>
            ...
            <div style={flexContainer}>
              ...
              <div style={halfWidth}>
                ...
                <select>
                  ...
                  <option>45min</option>
                  <option>1hour</option>
                  <option>1hour 15min</option>
                  <option>1hour 30min</option>
                  <option>1hour 45min</option>
                  <option>2hour</option>
                </select>
              </div>
            </div>
