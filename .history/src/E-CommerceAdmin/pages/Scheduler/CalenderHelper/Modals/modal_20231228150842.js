...
export const EditProfile = ({ show, handleClose, data }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      setSendEmailMarketingNotification(data?.user?.sendEmailMarketingNotification)
      setSendTextMarketingNotification(data?.user?.sendTextMarketingNotification)
      setPreferedLanguage(data?.user?.sendTextMarketingNotification)
    }
  }, [data]);
