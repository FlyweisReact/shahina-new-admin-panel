...
import { EditNotes, EditService, ProfileDetail } from "./Modals/modal";
...
const AppointmentDetails = ({
  ...
  function closeEditModal() {
    setService_Edit_Visible(false);
  }
  return (
    <>
      <NotesModal isNotes={isNotes} setIsNotes={setIsNotes} />
      <EditService show={service_edit_visible} handleClose={closeEditModal} />
      <UserDetailCanvas
        show={userOpen}
