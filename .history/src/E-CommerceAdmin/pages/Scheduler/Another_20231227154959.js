...
const Another = () => {
  ...
  // ---- Modal Slices
  const { showModal , modalData  } = useSelector(selectModalById("appointmentCanvas"));
  ...
  const modalId = "appointmentCanvas";

  // Use the selector to get the modal data
  const modal = useSelector(selectModalById(modalId));

  // Now you can access modalData
