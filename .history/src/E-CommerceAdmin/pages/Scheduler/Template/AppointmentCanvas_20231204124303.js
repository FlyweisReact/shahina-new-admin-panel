              ...
              <div className="payment_class">
                ...
                {isChecked && (
                  <p className="faded">
                    ...
                    your poilcy of <strong style={{color: ""}}>100% free</strong> for not showing up and{" "}
                    <strong>50% free</strong> for late cancellation under{" "}
                    <strong>48 hours </strong> notice{" "}
                  </p>
                )}
              </div>
            )}
