...
export const AppointmentCanvas = ({ show, handleClose, startTime }) => {
  ...
  const handleSwitchChange = () => {
    ...
    // Add any additional logic you want to perform when the switch is toggled
  };
            ...
            {type === "Payments" && (
              <div className="payment_class">
                ...
                <p>
                  ...
                  requiring them to confirm appointment with card and accept
                  your poilcy of <span>100% free</span> for not showing up and{" "}
                  <span>50% free</span> for late cancellation under{" "}
                  <span>48 hours </span> notice{" "}
                </p>
              </div>
            )}
          </>
