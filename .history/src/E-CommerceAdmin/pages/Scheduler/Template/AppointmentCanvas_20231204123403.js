          ...
          <>
            ...
            {type === "Payments" && (
              <div className="payment_class">
                ...
                <p>Once appointment is saved client will recieve  a notification requiring them to confirm appointment with card and accept your poilcy of <span>100% free</span>  </p>
              </div>
            )}
          </>
        ) : (
