...
const ContentTemplate = (props) => {
  ...
  const handleSearch = (e) => {
    ...
    setSearchTerm(term);
    const filtered = !searchTerm ?  service?.filter((option) =>
  ...
  const searchHandler = (e) => {
    ...
    const filtered = !search
      ...
      : users?.filter(
          (option) =>
            option.firstName.toLowerCase().includes(term.toLowerCase()) ||
            option.lastName.toLowerCase().includes(term.toLowerCase())
        );
