...
const NewCal = () => {
  ...
  //   Add Service
  const CustomEventEditor = (props) => {
    const handleAddService = () => {
      // Add your logic to add the service
      console.log("Add service logic here:", selectedDate, selectedSlot);

      // Close the custom modal after adding the service
