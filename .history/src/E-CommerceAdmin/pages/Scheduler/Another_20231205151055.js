...
const blockData = [
  {
    id: 1,
    title: "Blocked Time",
    start: new Date("2023-12-03T04:30:00.000Z"),
    end: new Date("2023-12-03T06:30:00.000Z"),
    isBlock: true, // Add isBlock property
  },
  {
    id: 2,
    title: "Blocked Time",
    start: new Date("2023-12-04T04:30:00.000Z"),
    end: new Date("2023-12-04T06:30:00.000Z"),
    isBlock: true, // Add isBlock property
  },
  {
    id: 3,
    title: "Blocked Time",
    start: new Date("2023-12-05T00:00:00.000Z"),
    end: new Date("2023-12-05T23:59:59.999Z"),
    isBlock: true, // Add isBlock property
  },
  {
    id: 4,
...
const Another = () => {
  ...
  // Custom EventWrapper to handle blocked time
  const EventWrapper = ({ event, children }) => {
    const isBlockedTime = event.isBlock === true;

    if (isBlockedTime) {
      return (
        <div style={{ backgroundColor: "lightgray", cursor: "not-allowed" }}>
          {children}
        </div>
      );
    }
