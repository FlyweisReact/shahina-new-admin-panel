...
const Chat = () => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    const documentRef = doc(db, "yourCollection", "documentId");

    // Assuming 'newString' is the new string you want to add to the 'reply' array
    const newString = "new value for reply array";

    try {
      // Use arrayUnion to add the new string to the 'reply' array
