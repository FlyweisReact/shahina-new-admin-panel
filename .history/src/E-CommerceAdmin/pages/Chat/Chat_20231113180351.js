...
const Chat = () => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      const existingReplies = documentSnapshot.data().reply || [];

      await updateDoc(documentRef, {
        reply: arrayUnion(newString, ...existingReplies),
        date: serverTimestamp(), // Assuming you want to update the date as well
      });
