...
const Contact = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const payload = { fb , twitter , google , instagram , basketball , behance , dribbble , pinterest , linkedIn , youtube , map , phone , address , supportEmail , infoEmail , openingTime , con}
