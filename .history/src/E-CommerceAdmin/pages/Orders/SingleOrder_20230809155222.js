    ...
    <section className="sectionCont">
      ...
      <div className="so1" id="pdfGen">
        ...
        <div className="below_Div">
          ...
          <p className="big_Head">THANK YOU FOR YOUR VALUED CUSTOM</div>

        <div className="text-cont">
          <h5>GOODS WITHOUT ENGLISH INGREDIENTS SHOULD BE LABELLED ACCORDINGLY BEFORE SALE</h5>
          <p>The goods once sold will not be returnable unless agreed. Pallet must be returned or a charge will be made</p>
        </div>
