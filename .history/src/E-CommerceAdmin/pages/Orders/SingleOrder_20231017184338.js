      ...
      <section className="sectionCont">
        ...
        {data?.billingAddresss && (
          <div className="Desc-Container">
            ...
            <p className="desc"> Apartment :  {data?.billingAddresss?.appartment} </p>
            <p className="desc"> City :  {data?.billingAddresss?.city} </p>
            <p className="desc"> Zip Code :  {data?.billingAddresss?.zipCode} </p>
          </div>
        )}
        {data?.deliveryAddresss && (
          <div className="Desc-Container">
            <p className="title"> Delivery Address </p>
            <p className="desc"> Address :  {data?.deliveryAddresss?.address} </p>
            <p className="desc"> Apartment :  {data?.deliveryAddresss?.appartment} </p>
            <p className="desc"> City :  {data?.deliveryAddresss?.city} </p>
            <p className="desc"> Zip Code :  {data?.deliveryAddresss?.zipCode} </p>
          </div>
        )}
        ...
        {data?.products?.map((i, index) => (
          <div className="Desc-Container" key={index}>
            ...
            <p className="desc"> {i?.quantity}</p>
            <p className="desc"> {i?.size}</p>
          </div>
        ))}
