...
export const getSlots = async (fromDate, toDate, page, limit) => {
  try {
    const res = await axios.get(
      `${Baseurl}api/v1/api/v1/admin/Slot/getSlotForAdmin?fromDate=${fromDate}&toDate=${toDate}&page${page}=&limit=${limit}`
    );
    const data = res.data.data
    setResponse(data)
  } catch {}
