...
// Suggestion  Cart
export const deleteSuggestion = async (userId ,suggesstionId) => {
  try{
    const res=  await axios.delete(`${Baseurl}api/v1/api/v1/admin/deleteSuggestionfromCart/${suggesstionId}/${suggesstionId}`)
  }catch{}
}
