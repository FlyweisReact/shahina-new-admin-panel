...
export const getSlots = async (fromDate , date  , page , limit) => {
  try {
const res = await axios.get(`${Baseurl}api/v1/api/v1/admin/Slot/getSlotForAdmin?fromDate=&toDate=&page=&limit=`)
  }catch{}
}