...
export const edit_service_in_order = async (orderId, payload, fetchCart) => {
  try {
    const res = await axios.put(
...
export const edit_adonservice_in_order = async (
  orderId,
  payload,
  fetchCart
) => {
...
export const send_reminder = async (id) => {
  try {
    ...
    if (res.status === 200) {
      showMsg("Confirmation sended", "", "success");
    }
  } catch {}
};
...
export const add_service_in_order = async (orderId, payload, fetchHandler) => {
  return async (dispatch) => {
...
export const addOn_service_in_order = async (
  orderId,
  payload,
  fetchHandler
) => {
...
export const delete_booked_service = async (orderId, payload, fetchHandler) => {
  try {
    const res = await axios.put(
...
export const delete_booked_adOnservice = async (orderId, payload, fetchHandler) => {
  try {
    const res = await axios.put(
